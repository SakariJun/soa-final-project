...
$(document).on("click", "#user-salary", function() {
    $(".active").removeClass('active');
    $(this).parent('li').addClass('active');
    $(this).parent('li').parent().parent('li').addClass('active');
    $.ajax({
        url: './app/salary-management.php',
        type: 'POST',
        data: {
            'action': "LOAD"
        },
...
// Chức năng xem danh sách yêu cầu nghỉ phép và duyệt yêu cầu DÀNH CHO Trưởng phòng và Giám đốc
